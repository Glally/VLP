...
//AnalysisView Component Constructor
function AnalysisView() {
	...
	var Analysis = require('ui/common/Analysis');
...
//create analysis button
	...
	var button7 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Analysis/homeA.png',
		backgroundSelectedImage:'ui/common/image/Analysis/homeA.png',
		top:'30%', //'382',
		left:'45%', //'156',
		width:'29',
		height:'32'
	...
	var button8 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Analysis/deleteA.png',
		backgroundSelectedImage:'ui/common/image/Analysis/deleteA.png',
		top:'52%', //'410',
		left:'40%', //'141',
		width:'29',
		height:'32'
...
//create delete button
	var button9 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Analysis/saveA.png',
		backgroundSelectedImage:'ui/common/image/Analysis/saveA.png',
		top:'52%', //'410',
		left:'50%', //'173',
		width:'29',
		height:'32'
	...
	var button10 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Analysis/printA.png',
		backgroundSelectedImage:'ui/common/image/Analysis/printA.png',
		top:'30%', //'382',
		left:'55%', //'188',
		width:'29',
		height:'32'
	...
	var button11 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Analysis/audioA.png',
		backgroundSelectedImage:'ui/common/image/Analysis/audioA.png',
		top:'30%',//'382', -17
		left:'35%', //'124', - 15
		width:'29',
		height:'32'
	...
	var button12 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Analysis/scheduleA.png',
		backgroundSelectedImage:'ui/common/image/Analysis/scheduleA.png',
		top:'52%', //'410',
		left:'60%', //'205',
		width:'29',
		height:'32'
	...
	var button13 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Analysis/dataA.png',
		backgroundSelectedImage:'ui/common/image/Analysis/dataA.png',
		top:'52%', //'410',
		left:'30%', //'109',
		width:'29',
		height:'32'
	});
	bottomPartScreen.add(button13);
