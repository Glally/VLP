...
//create analysis button
	...
	var button7 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Map/homeM.png',
		backgroundSelectedImage:'ui/common/image/Map/homeM.png',
		top:'30%', //'382',
		left:'45%', //'156',
		width:'29',
		height:'32'
	...
	var button8 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Map/deleteM.png',
		backgroundSelectedImage:'ui/common/image/Map/deleteM.png',
		top:'52%', //'410',
		left:'40%', //'141',
		width:'29',
		height:'32'
...
//create delete button
	var button9 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Map/saveM.png',
		backgroundSelectedImage:'ui/common/image/Map/saveM.png',
		top:'52%', //'410',
		left:'50%', //'173',
		width:'29',
		height:'32'
	...
	var button10 = Ti.UI.createButton({
		backgroundImage:'ui/common/image/Map/printM.png',
		backgroundSelectedImage:'ui/common/image/Map/printM.png',
		top:'30%', //'382',
		left:'55%', //'188',
		width:'29',
		height:'32'
